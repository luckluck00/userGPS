...
export declare class TunnelConnection {
    ...
    invokeAsync(httpRequest: HttpRequestLike, abortSignal?: AbortSignalLike): Promise<HttpResponseLike>;
    stop(): void;
    private getRandomKey;
    private getClient;
    private processMessage;
    stopConnection(id: string): void;
    startConnectionAsync(target: ConnectionTarget, abortSignal?: AbortSignalLike): Promise<string>;
    private tryEndLife;
