...
class HttpServerProxy {
    ...
    async getLiveTraceUrl() {
        ...
        if ((0, core_auth_1.isTokenCredential)(this.credential)) {
            ...
            token = jsonwebtoken_1.default.sign({}, this.credential.key, {
                audience: `${this.endpoint}livetrace`,
                expiresIn: "1h",
                algorithm: "HS256",
            });
            toolToken = jsonwebtoken_1.default.sign({}, this.credential.key, {
