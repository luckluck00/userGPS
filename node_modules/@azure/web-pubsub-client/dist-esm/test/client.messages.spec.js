        ...
        it("join group without ack id", () => {
            assert.doesNotThrow(() => {
                ...
                mock
                    ...
                    .once()
                    .withArgs({ kind: "joinGroup", group: "groupName", ackId: 1 })
        ...
        it("join group with ack id", () => {
            assert.doesNotThrow(() => {
                ...
                mock
                    .expects("_sendMessage")
                    .once()
                    .withArgs({ kind: "joinGroup", group: "groupName", ackId: 2233 })
                    .callsFake((_) => Promise.resolve());
                client.joinGroup("groupName", { ackId: 2233 });
                mock.verify();
            });
        });
        it("leave group without ack id", () => {
            assert.doesNotThrow(() => {
                ...
                mock
                    .expects("_sendMessage")
                    .once()
                    .withArgs({ kind: "leaveGroup", group: "groupName", ackId: 1 })
                    .callsFake((_) => Promise.resolve());
        ...
        it("leave group with ack id", () => {
            assert.doesNotThrow(() => {
                ...
                mock
                    .expects("_sendMessage")
                    .once()
                    .withArgs({ kind: "leaveGroup", group: "groupName", ackId: 2233 })
                    .callsFake((_) => Promise.resolve());
                client.leaveGroup("groupName", { ackId: 2233 });
                mock.verify();
            });
        });
...
//# sourceMappingURL=client.messages.spec.js.map